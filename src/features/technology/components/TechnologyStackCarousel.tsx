...
import InfiniteCarousel from '@/shared/ui/carousel/InfiniteCarousel';
import { 
  SiReact, 
  SiNodedotjs, 
  SiExpress, 
...
const SvgImg: React.FC<SvgImgProps> = ({ src, alt, size = 24, ...props }) => (
...
const TechnologyStackCarousel: React.FC = React.memo(() => {
