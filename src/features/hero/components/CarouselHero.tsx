...
import OptimizedLiquidBackground from "@/shared/backgrounds/OptimizedLiquidBackground";
...
const CarouselHero: React.FC = () => {
  ...
  const slides: Slide[] = [
    ...
    },
    {
      ...
      description: "Smart Supplier Selection",
    ...
    },
    {
      ...
      description: "Identifies trends and demand shifts early for proactive planning",
    ...
    },
    {
      ...
      description: "Agile focused flexible PODs that handles end-to-end application builds from UI/UX to scalable backends",
