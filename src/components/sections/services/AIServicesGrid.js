...
const AIServicesGrid = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Comprehensive application development and testing services leveraging our top 10 technology expertise including Java & .NET, React/Node.js, DevOps, Microservices, Cloud platforms, APIs, Databases, Python, Serverless, and Agile methodologies.",
      color: "from-blue-500 to-blue-600",
      bgColor: "bg-blue-50",
      borderColor: "border-blue-200"
    },
