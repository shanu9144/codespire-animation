...
const SalesforceServiceNowExpertise = () => {
  ...
  const salesforceServices = [
    {
      icon: DollarSign,
      title: "Sales Cloud",
      description: "Supercharge your sales processes. We streamline workflows, sharpen forecasting, and help you close deals faster.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Headphones,
      title: "Service Cloud",
      description: "Wow your customers. Our solutions bring efficient, personalized support to every interaction, fostering loyalty.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Megaphone,
      title: "Marketing Cloud",
      description: "Capture attention and drive engagement. We design targeted campaigns, nurture leads effectively, and track ROI with precision.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Globe,
      title: "Experience Cloud",
      description: "Connect your world. Build vibrant portals that spark collaboration and strengthen customer loyalty.",
      color: "from-blue-500 to-blue-600"
    }
  ];
  ...
  const serviceNowServices = [
    {
      ...
      description: "Streamline your IT operations. We implement solutions for incident management, problem management, change management, and more, improving efficiency and reducing downtime.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Activity,
      title: "IT Operations Management (ITOM)",
      description: "Gain proactive control over your IT infrastructure. Our services help you monitor, automate, and optimize your IT environment for peak performance.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: UserCheck,
      title: "Customer Service Management (CSM)",
      description: "Deliver exceptional customer experiences across all channels with ServiceNow's unified platform.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Terminal,
      title: "Platform App Development",
      description: "Extend the power of ServiceNow. We build custom applications to address your unique business needs and workflows.",
      color: "from-blue-500 to-blue-600"
    }
  ];
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <div className="mb-8">
              <h2 className="text-4xl md:text-5xl font-bold">
                <span className="text-[#2D3748]">Our Salesforce &</span><br />
                <span className="text-[#6B46C1]">ServiceNow Expertise</span>
              </h2>
            </div>
            <p className="text-xl text-[#4A5568] leading-relaxed">
              Comprehensive solutions leveraging industry-leading platforms to transform your business operations and customer experiences.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            <div className="text-center">
              <h3 className="text-3xl md:text-4xl font-bold mb-4">
                <span className="text-[#2D3748]">Salesforce</span>
              </h3>
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            <div className="text-center">
              <h3 className="text-3xl md:text-4xl font-bold mb-4">
                <span className="text-[#2D3748]">ServiceNow</span>
              </h3>
              <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto rounded-full"></div>
            </div>
            ...
            <motion.div
              ...
              className="grid grid-cols-1 md:grid-cols-2 gap-8"
            >
              {serviceNowServices.map((service, index) => {
                const Icon = service.icon;
                return (
                  <motion.div
                    key={service.title}
...
export default SalesforceServiceNowExpertise;
