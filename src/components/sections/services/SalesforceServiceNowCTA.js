          ...
          <motion.div variants={itemVariants} className="space-y-8">
            <h2 className="text-5xl font-semibold text-gray-900 leading-tight">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                Salesforce & ServiceNow Solutions
              </span>
            </h2>
            
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Unlock the full potential of your CRM and ITSM platforms with our certified experts. We deliver custom implementations that drive efficiency and growth.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="pt-8">
            ...
            >
              ...
              <span className="relative flex items-center gap-3">
                Get Enterprise Consultation <ArrowRight className="w-5 h-5" />
              </span>
            </motion.a>
          </motion.div>
        </motion.div>
...
export default SalesforceServiceNowCTA;
