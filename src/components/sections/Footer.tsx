...
const Footer = () => {
  ...
  const contactInfo = [
    ...
    { icon: MapPin, label: '25th Floor, Gold Tower, Wave One, 2514, Sector 18, Noida, Uttar Pradesh 201301, India', href: 'https://maps.google.com/?q=25th%20Floor%2C%20Gold%20Tower%2C%20Wave%20One%2C%202514%2C%20Sector%2018%2C%20Noida%2C%20Uttar%20Pradesh%20201301' },
  ];
