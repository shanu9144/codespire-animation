...
const MVPServicesHero = () => {
  return (
    <section className="relative pt-20 pb-16 flex items-center justify-center overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50/80 via-white/70 to-purple-50/60" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-cyan-500/10 rounded-full blur-xl"
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.2, 0.5, 0.2],
          }}
...
export default MVPServicesHero;
