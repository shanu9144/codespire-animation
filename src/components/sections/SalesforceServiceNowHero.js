        ...
        >
          <div className="space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
              <span className="text-[#2D3748]">Salesforce & ServiceNow</span><br />
              <span className="text-3xl md:text-4xl lg:text-5xl bg-gradient-to-r from-[#6B46C1] to-[#8B5CF6] bg-clip-text text-transparent">Enterprise Solutions</span>
            </h1>
...
export default SalesforceServiceNowHero;
