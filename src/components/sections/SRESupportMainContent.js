...
const SRESupportMainContent = () => {
  ...
  const sreServices = [
    {
      ...
      description: 'Continuous system monitoring with real-time alerts and proactive issue detection.',
    ...
    },
    {
      ...
      description: 'Rapid response to system issues with defined SLAs and escalation procedures.',
    ...
    },
    {
      ...
      description: 'Continuous tuning and optimization to improve system performance and efficiency.',
    ...
    },
    {
      ...
      description: 'Proactive capacity management to ensure systems can handle growing demands.',
    ...
    },
    {
      ...
      description: 'Comprehensive backup and recovery strategies to minimize data loss and downtime.',
    ...
    },
    {
      ...
      description: 'Continuous security monitoring and threat detection to protect your systems.',
  ...
  return (
    <section ref={ref} className="relative py-24 px-6 overflow-hidden">
      ...
      {/* SRE monitoring pattern */}
      <div className="absolute inset-0 opacity-10">
        <svg className="w-full h-full" viewBox="0 0 1000 1000" fill="none">
          <defs>
            <pattern id="sre-monitoring" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#sre-monitoring)" />
        </svg>
      </div>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  ...
                  <motion.div variants={itemVariants}>
                    <p className="text-xl text-gray-700 leading-relaxed mb-8">
                      At <span className="text-blue-600 font-semibold">CodeSpire Solutions</span>, our Site Reliability Engineering (SRE) team provides comprehensive 24/7 support to ensure your systems maintain optimal performance and reliability. We combine proactive monitoring, rapid incident response, and continuous optimization to minimize downtime and maximize system efficiency.
                    </p>
                    <p className="text-lg text-gray-600 leading-relaxed">
                      Whether you need robust system monitoring built from scratch or expert support to scale your infrastructure, we deliver bespoke services in <span className="text-blue-600 font-semibold">24/7 monitoring, incident response, performance optimization, capacity planning, disaster recovery, security monitoring</span>, and more.
                    </p>
                  </motion.div>
                  
                  {/* SRE Services Heading */}
                  <motion.div variants={itemVariants}>
                        ...
                        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/50 hover:border-blue-300/50 transition-all duration-300 hover:bg-white/80 hover:shadow-lg">
                          <div className="flex items-start gap-4">
                            <motion.div
                              ...
                              className={`w-12 h-12 bg-gradient-to-r ${service.gradient} rounded-xl flex items-center justify-center shadow-lg ${service.glow} group-hover:shadow-xl transition-all duration-300`}
                            >
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-blue-50/80 to-indigo-50/60 rounded-3xl p-8 border border-blue-200/50 backdrop-blur-sm">
                    ...
                    {/* Main visual - SRE Monitoring Display */}
                    <div className="bg-gray-900/90 rounded-2xl p-6 border border-blue-300/30">
                      <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <span className="text-blue-300 text-sm ml-4">SRE Monitoring Dashboard</span>
                        </div>
                        
                        <div className="space-y-2 font-mono text-sm">
                          <div className="text-blue-400">
                            <span className="text-purple-400">const</span> <span className="text-cyan-300">sreSystem</span> = <span className="text-yellow-300">new</span> <span className="text-green-400">Monitoring</span>();
                          </div>
                          <div className="text-blue-300">
                            <span className="text-purple-400">sreSystem</span>.<span className="text-cyan-300">enable24x7</span>(<span className="text-green-400">true</span>);
                          </div>
                          <div className="text-blue-400">
                            <span className="text-purple-400">sreSystem</span>.<span className="text-cyan-300">setSLA</span>(<span className="text-green-400">'99.9%'</span>);
                          </div>
                          <div className="text-gray-400">
                            <span className="text-gray-500">//</span> <span className="text-cyan-300">Ensuring system reliability</span>
                          </div>
                        </div>
                      </div>
                    </div>
