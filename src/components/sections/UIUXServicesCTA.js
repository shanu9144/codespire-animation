...
const UIUXServicesCTA = () => {
  ...
  const stats = [
    ...
    { value: "70%", label: "Faster Design-to-Development Cycle" },
    { value: "Data-Driven", label: "Decisions at Every Stage" }
  ];
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-[#2D3748]">Create Experiences</span><br />
              <span className="text-[#6B46C1]">that Drive Impact</span>
            </h2>
            <p className="text-xl text-[#4A5568] leading-relaxed mb-12">
              Deliver exceptional user experiences that delight customers and accelerate business growth. 
              Partner with CodeSpire to blend creativity, intelligence, and innovation — all through our AI-powered UI/UX as a Service.
            </p>
          </motion.div>
...
export default UIUXServicesCTA;
