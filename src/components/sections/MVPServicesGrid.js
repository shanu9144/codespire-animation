  ...
  const services = [
    {
      ...
      description: "Quickly assess product feasibility with AI-driven analytics, user behavior insights, and technical proof-of-concepts.",
    ...
    },
    {
      ...
      description: "Create interactive, high-fidelity prototypes that simulate user experience, functionality, and performance.",
      color: "from-blue-500 to-blue-600",
      bgColor: "bg-blue-50",
      borderColor: "border-blue-200"
    },
    {
      ...
      description: "Build a market-ready minimum viable product using scalable cloud architectures and modular AI components.",
      color: "from-blue-500 to-blue-600",
      bgColor: "bg-blue-50",
      borderColor: "border-blue-200"
    },
    {
      ...
      description: "Leverage AI to refine designs, enhance usability, and optimize user flows based on real-world feedback.",
      color: "from-blue-500 to-blue-600",
      bgColor: "bg-blue-50",
      borderColor: "border-blue-200"
    },
    {
      icon: RefreshCw,
      title: "Agile Testing & Iteration",
      description: "Validate your MVP with automated testing, A/B experiments, and real-time performance analytics.",
      color: "from-blue-500 to-blue-600",
      bgColor: "bg-blue-50",
      borderColor: "border-blue-200"
    },
    {
      icon: Layers,
      title: "Scalable Transition to Full Product",
      description: "Seamlessly evolve your MVP into a production-grade product with continuous integration and scalable engineering.",
      color: "from-blue-500 to-blue-600",
      bgColor: "bg-blue-50",
      borderColor: "border-blue-200"
    }
          ...
          >
            <div className="mb-8">
              <h2 className="text-4xl md:text-5xl font-bold">
                <span className="text-[#2D3748]">Our AI-Powered MVP</span><br />
                <span className="text-[#6B46C1]">& Prototyping Services</span>
              </h2>
            </div>
            <p className="text-xl text-[#4A5568] leading-relaxed">
              Comprehensive services designed to accelerate innovation, validate ideas, and deliver working prototypes that drive real business impact.
            </p>
          </motion.div>
...
export default MVPServicesGrid;
