      ...
      <Wrapper>
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            >
              Book a personalized demo with our team to see how CodeSpire can transform your business. 
          ...
          >
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Quick and focused demo tailored to your needs</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Meet with our solution architects and developers</p>
            </div>
          </motion.div>
          ...
          >
            <div className="text-center mb-6">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Choose Your Preferred Time</h2>
          ...
          >
            <div className="bg-white rounded-lg shadow-sm p-6 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="mailto:demo@codespire.com" 
