        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Proactive monitoring, rapid incident response, and continuous optimization. Our SRE team ensures your systems maintain peak performance and reliability.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              { icon: Target, label: '< 5min', desc: 'Response Time' },
