        ...
        >
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-2xl text-[#4A5568] leading-relaxed max-w-4xl mx-auto">
              Ensure your systems run smoothly around the clock with our Site Reliability Engineering (SRE) services. We provide proactive monitoring, incident response, and continuous optimization to maximize uptime and performance.
            </p>
          </div>
        </motion.div>
      </div>
